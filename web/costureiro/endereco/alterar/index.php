...
<head>
  ...
  $infoEndereco = buscarEnderecosUsuario($conexao, $_SESSION["cos_id"]);
...
<body>
  ...
  <header class="top">
    ...
    <a class="icon" href="../../perfil/">
      <img class="icon_img_perfil" src="../../../assets/uploads/profilepictures/<?php echo $_SESSION["cos_perfil"]; ?>"
        alt="Foto de perfil" />
    </a>
    <!--user-->
  </header>
  ...
  <div class="secoes">
    ...
    <form class="informacoes" method="POST" action="alterarEnderecoDetalhes.php">
      ...
      <input hidden name="txtID" value="<?php echo $_SESSION["cos_id"]; ?>">
      <div class="endereco_grid">
        <div class="info_endereco">
          <div class="dado_endereco">
            <p class="label">Rua</p>
            <input name="txtRua" type="text" id="rua" class="input"
              value="<?php echo $infoEndereco[0]["cos_rua"]; ?>" disabled />
          </div>
          <div class="dado_endereco">
            <p class="label">Número</p>
            <input name="txtNumero" type="text" id="numero" class="input"
              value="<?php echo $infoEndereco[0]["cos_numero"]; ?>" placeholder="123" disabled />
          </div>
          <p class="label">Bairro</p>
          <input name="txtBairro" type="text" id="bairro" class="input"
            value="<?php echo $infoEndereco[0]["cos_bairro"]; ?>" disabled />
          <p class="label">Complemento</p>
          <textarea name="txtComplemento" id="complemento" class="input" rows="4" placeholder="Escreva no máximo 255 caracteres" disabled><?php echo $infoEndereco[0]["cos_complemento"]; ?></textarea>
        </div>
        ...
        <div class="info_endereco_dois">
          <div class="dado_endereco">
            ...
            <input type="text" name="txtCidade" id="cidade" class="input"
              value="<?php echo $infoEndereco[0]["cos_cidade"]; ?>" disabled />
          </div>
          <div class="dado_endereco">
            ...
            <select name="txtEstado" id="estado" class="input" disabled>
              ...
              for ($i = 0; $i < 27; $i++) {
                ...
                if ($infoEndereco[0]["cos_estado"] == $listaDosEstados[$i]) {
                  echo " selected ";
                }
          ...
          <input type="text" name="txtCEP" id="cep" class="input"
            value="<?php echo $infoEndereco[0]["cos_cep"]; ?>" placeholder="00000-00" disabled />
        </div>
      </div>
