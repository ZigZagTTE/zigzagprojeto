...
const txtCNH = document.getElementById("txtCNH");
...
txtCNH.addEventListener("input", testeVazio);
...
function testeSenhas(evento) {
  ...
  if (!pattern.test(txtSenha.value)) {
    ...
    erroSenha.innerHTML =
      "É preciso ter ao menos 8 caracteres, uma letra maíuscula, uma minúscula e um número";
