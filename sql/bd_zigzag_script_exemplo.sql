...
VALUES  ('clienteA@exemplo.com', '1234abcD', 12345678901, 'Cliente A', '2001-01-01', 12123456789, 'https://vectorified.com/images/default-user-icon-33.jpg'),
        ('clienteB@exemplo.com', 'ABCd1234', 98765432110, 'Cliente B', '2002-02-02', 12987654321, 'https://vectorified.com/images/default-user-icon-33.jpg');
...
VALUES  ('entregadorA@exemplo.com', '1234abcD', 'Entregador A', 000123456789, 12345678902, 12123456790, 'https://vectorified.com/images/default-user-icon-33.jpg'),
        ('entregadorB@exemplo.com', 'ABCd1234', 'Entregador B', 000123456790, 98765432111, 12987654322, 'https://vectorified.com/images/default-user-icon-33.jpg');
